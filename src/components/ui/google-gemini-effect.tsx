    ...
    <div className={cn("sticky top-0 h-screen w-full", className)}>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <svg
          ...
          className="absolute left-1/2 top-[40%] sm:top-[45%] md:top-[55%] -translate-x-1/2 -translate-y-1/2 w-[200%] sm:w-[150%] md:w-[120%] lg:w-full"
          preserveAspectRatio="xMidYMid slice"
        >
          {/* Gaussian blur background paths */}
          <path
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-end pb-[35vh] sm:pb-[30vh] md:justify-center md:pb-0 px-4">
        {/* Top Badge */}
        {badge && (
          <motion.div
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-orange-500 to-orange-600 rounded-full shadow-lg shadow-orange-500/25">
              {badge}
            </span>
          </motion.div>
        )}
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-orange-300 via-orange-400 to-orange-600"
        >
          {title || `판타스캔 AI`}
        </motion.h1>
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl lg:text-2xl font-normal text-neutral-400 mt-4 sm:mt-6 max-w-2xl mx-auto text-center"
        >
